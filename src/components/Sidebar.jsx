...
const Sidebar = ({ sidebarFullVisible, setSidebarFullVisible }) => {
  ...
  return (
    ...
    fixed left-0 top-0 h-screen z-50 p-1 flex flex-col justify-between bg-white transition-all duration-500`} 
    style={{ borderRight: '1px solid #d1d5db' }}>
      ...
      <div className='flex flex-col items-center gap-1 w-full'>
        <div className='mb-3'>
          {
            sidebarFullVisible?  <BuyNowCard/> : <div className='flex iems-center justify-center px-6 py-3 rounded-md bg-[#FCE5E5] cursor-pointer'>
