...
const Navbar = ({sidebarFullVisible}) => {
  ...
  return (
    <div className='flex w-full fixed z-20 justify-between px-6 py-3 bg-white' style={{ borderBottom: '1px solid #C5C5C5', left: sidebarFullVisible? 240:82, width:`calc(100% - ${sidebarFullVisible?  240 : 82}px)` }}>
